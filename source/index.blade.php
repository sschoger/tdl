...
<div class="header bgg10 pt4 ">
			<div class="container">
			<div class="tdl-logo mb4 "><img src="/img/tdl-logo.png"></div>
			<h1 class="tcg70 sans fw3 ft10 tac lh1-4 mb2">A step-by-step training course on building well-designed, robust Laravel applications with TDD.</h1>
			</div>
		</div>
		<div class="container">
			<div class="card nmt6 pa2 bgw brdr1 bcg20 br6 mb4 lh1-4">
				<p class="fw4 ft4 tac pb2 mb2 brdr1--bottom bcg20 lh1-4 tcg50">Sign up below to be the first to know when it launches and to recieve an exclusive launch discount.  You'll also get four free preview lessons delivered to check out in the mean time!</p>
				<form action="/">
		...
		<div class="section-about pv4 tal lh1-4">
			...
			<p class="tcg50 fw4 ft4 mb2 lh1-4">Simple examples are fine for learning the basics, but Test-Driven Laravel is the course that show you how to apply this stuff to real products you would actually build on the job.</p>
